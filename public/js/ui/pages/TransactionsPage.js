...
class TransactionsPage {
  ...
  renderTitle(name){
    ...
    this.element.querySelector('.content-description').textContent = 'Счёт';
  }
  ...
  formatDate(date){
    ...
    return `${d.getDate()} ${d.toLocaleString('ru', { month: 'long' })} ${d.getFullYear()} г. в ${d.getHours()}:${d.getMinutes()}`;
  }
